...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		<td>
		<h3>所有員工資料<br>
		    <font color=red>(listAllEmp_04_EL_Test_<font color=blue>href_include</font>.jsp)</font></h3>
		</td>
	</tr>
</table>
...
<table border='1' bordercolor='#CCCCFF' width='800'>
	...
	<c:forEach var="empVO" items="${empDAO.all}" >
		<tr align='center' valign='middle'>
			<td><a href="test_emp.do?empno=${empVO.empno}&action=getOne_From04">${empVO.empno}</a></td>
			<td>${empVO.ename}</td>
			<td>${empVO.job}</td>
